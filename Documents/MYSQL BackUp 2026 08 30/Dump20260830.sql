...
INSERT INTO `comments` VALUES (2084,8,18,'මේකේ ගනන් කොහොමද?','2026-07-06 15:08:47','2026-07-06 15:08:47',NULL),(2085,1,18,'@kasun_owner 5000 LKR.','2026-07-06 15:09:22','2026-07-06 15:09:22',2084),(2087,9,15,'This is a Good Service...','2026-08-28 17:37:25','2026-08-28 17:37:25',NULL),(2088,1,15,'@nimali_parent Thank You So Much !!! ....','2026-08-28 17:38:05','2026-08-28 17:38:05',2087);
...
INSERT INTO `favorites` VALUES (1,15,'2026-08-30 09:29:34'),(1,18,'2026-07-08 17:07:29');
...
--
-- Table structure for table `post_status_log`
--

DROP TABLE IF EXISTS `post_status_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `post_status_log` (
  ...
  `action` varchar(20) NOT NULL COMMENT 'approved, rejected, hold',
  `changed_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`log_id`),
  KEY `service_id` (`service_id`),
  KEY `admin_id` (`admin_id`),
  CONSTRAINT `post_status_log_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`) ON DELETE CASCADE,
  CONSTRAINT `post_status_log_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `post_status_log`
--

LOCK TABLES `post_status_log` WRITE;
/*!40000 ALTER TABLE `post_status_log` DISABLE KEYS */;
INSERT INTO `post_status_log` VALUES (1,18,1,'rejected','2026-07-06 17:02:07'),(2,18,1,'hold','2026-07-06 17:02:29'),(3,18,1,'approved','2026-07-06 17:02:43'),(4,15,1,'hold','2026-07-06 17:03:36'),(5,15,1,'approved','2026-07-06 17:03:45'),(6,18,1,'approved','2026-08-28 10:26:13'),(7,15,1,'approved','2026-08-28 10:26:19'),(8,18,1,'approved','2026-08-30 09:33:42');
/*!40000 ALTER TABLE `post_status_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ratings` VALUES (27,1,15,5,'2026-07-05 17:42:17','2026-07-05 17:42:17'),(28,1,18,5,'2026-07-06 14:21:57','2026-07-06 14:21:57');
...
INSERT INTO `reports` VALUES (1,10,1,'[\"1\",\"2\",\"3\",\"4\",\"5\",\"6\"]','මේක test එකක්. ','2026-06-20 16:30:40'),(2,10,1,'[\"1\",\"2\"]','','2026-06-20 17:00:23'),(3,18,1,'[\"1\"]','','2026-07-06 16:47:49');
...
INSERT INTO `service_document_images` VALUES (19,15,NULL,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15_documents/doc_1783272610_0_7807.png','2026-07-05 17:30:10'),(20,15,NULL,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15_documents/doc_1783272610_1_7218.png','2026-07-05 17:30:10'),(21,15,NULL,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15_documents/doc_1783272610_2_7526.png','2026-07-05 17:30:10'),(22,15,NULL,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15_documents/doc_1783272610_3_9199.png','2026-07-05 17:30:10'),(23,15,NULL,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15_documents/doc_1783272610_4_5672.png','2026-07-05 17:30:10'),(24,15,NULL,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15_documents/doc_1783272610_5_1307.png','2026-07-05 17:30:10'),(37,18,NULL,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18_documents/doc_1783274585_0_8174.png','2026-07-05 18:03:05'),(38,18,NULL,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18_documents/doc_1783274585_2_3230.png','2026-07-05 18:03:05');
...
INSERT INTO `service_emails` VALUES (70,15,'abcdenglishlearning011@gmail.com'),(71,18,'abcdenglishlearning011@gmail.com');
...
INSERT INTO `service_images` VALUES (65,15,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15/2_1783272610_6971.png',2,2,'2026-07-05 17:30:10'),(66,15,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15/3_1783272610_3146.png',3,3,'2026-07-05 17:30:10'),(67,15,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15/4_1783272610_3844.png',4,4,'2026-07-05 17:30:10'),(68,15,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15/5_1783272610_2090.png',5,5,'2026-07-05 17:30:10'),(69,15,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15/6_1783272610_4718.png',6,6,'2026-07-05 17:30:10'),(84,18,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18/2_1783274585_6702.png',2,2,'2026-07-05 18:03:05'),(85,18,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18/3_1783274585_8024.png',3,3,'2026-07-05 18:03:05'),(86,18,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18/4_1783274585_4297.png',4,4,'2026-07-05 18:03:05'),(88,18,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18/6_1783274585_6584.png',6,6,'2026-07-05 18:03:05'),(93,18,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18/5_1783354032_7358.png',5,5,'2026-07-06 16:07:12'),(94,18,'uploads/Sabaragamuwa/Ratnapura/W.G Sithum Deemantha Service New New_18/1_1787912751_6931.jpg',1,1,'2026-08-28 10:25:51'),(95,15,'uploads/Sabaragamuwa/Ratnapura/Sithum Service new_15/1_1787912763_4855.jpg',1,1,'2026-08-28 10:26:03');
...
INSERT INTO `service_schedules` VALUES (67,15,'Afternoon Trip 1','R/ Emb / Embilipitiya Royal Collage','13:30:00',1),(68,18,'Afternoon Trip 1','R/ Emb / Embilipitiya Royal Collage','13:00:00',1),(69,18,'Morning Trip 1','Udawalawa Beriyar Junction','06:00:00',2);
...
INSERT INTO `service_schools` VALUES (73,15,'R/ Emb / Embilipitiya Royal Collage'),(74,18,'R/ Emb / Embilipitiya Royal Collage');
...
INSERT INTO `service_telephones` VALUES (72,15,'0787216051'),(73,18,'0787216051');
...
INSERT INTO `service_websites` VALUES (47,15,'aaaaaaaaaaaaaa'),(48,18,'aaaaaaaaaaaaaa');
...
INSERT INTO `services` VALUES (15,1,'Sithum Service new','123','Bus','Private Institute Transport','W.G Sithum Deemantha','W.G Sithum Deemantha','123456','Sabaragamuwa','Ratnapura','Udawalawa','Embilipitiya, Udawalawa, 96 Junction','N0 87, Samagi Maawatha, Walawa Junction, Kolambageara','අපි හොඳයි අනේ...','',0,NULL,NULL,0,NULL,NULL,'2026-07-05 17:30:10','2026-08-28 10:26:19','approved',0),(18,1,'W.G Sithum Deemantha Service New New','78964','Bus','School Transport','W.G Sithum Deemantha','W.G Sithum Deemantha','1234567565454','Sabaragamuwa','Ratnapura','Udawalawa','Embilipitiya, Udawalawa, 96 Junction','N0 87, Samagi Maawatha, Walawa Junction, Kolambageara','','',0,NULL,NULL,0,NULL,NULL,'2026-07-05 18:03:05','2026-08-30 09:33:42','approved',0);
...
INSERT INTO `team_members` VALUES (2,'Sithum Deemantha','Software Engineer','Bio is Here','uploads/Members/Sithum_Deemantha/Sithum_Deemantha.jpeg','uploads/Members/Sithum_Deemantha',0);
...
-- Dump completed on 2026-08-30 16:07:59
