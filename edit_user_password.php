...
include "includes/audit_helper.php"; // ✅ added
    ...
    elseif ($step === 'change_password') {
        if (!isset($_SESSION['code_verified']) || $_SESSION['code_verified'] !== true) {
            ...
            if (empty($new_password) || empty($confirm_password)) {
                ...
                if ($stmt->execute()) {
                    // ✅ AUDIT LOG – self password change
                    $oldData = ['password' => '********'];
                    $newData = ['password' => '********', 'note' => 'Self password changed via email verification'];
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .step-connector {
            ...
            border-radius: 2px;
            margin: 0 6px;
            margin-bottom: 22px; /* visual align with circles */
...
<div class="pw-wrapper">
    ...
    <div class="page-header">
        ...
        <div class="page-header-text">
            ...
            <p>Secure your account in three quick steps.</p>
        </div>
    </div>
    ...
    <div class="pw-card">
        <div class="card-body">
            ...
            <?php if ($step === 'send_code'): ?>
                ...
                <p class="info-note">
                    We'll send a <strong>6-digit code</strong> to your registered email.<br>
            ...
            <?php elseif ($step === 'verify_code'): ?>
                ...
                <form method="post" style="margin-top: 20px;">
                    ...
                    <div class="form-actions-row" style="margin-top: 4px;">
                        ...
                        <a href="edit_user_password.php" class="btn-ghost-custom">
        ...
        <div class="card-footer-strip">
            ...
            <a href="index.php" class="btn-text-custom">
